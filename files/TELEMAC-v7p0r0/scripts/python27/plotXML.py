...
"""
"""@brief
   Simpler tools for plotting plot items from XML files directly
...
#
   ...
   options.todos = { 'draw':{'rank':0,'todo':''},
      'act':{'rank':-1,'todo':''},'save':{'rank':-1,'todo':''},'cast':{'rank':-1,'todo':''} }

# <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
# ~~~~ Trying to fit it with validateTELEMAC ~~~~~~~~~~~~~~~~~~~~~~~
   cfg = { 'display':options.display, 'REBUILD':0 }
